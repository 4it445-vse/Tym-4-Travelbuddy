                ...
                <form>
                    ...
                    <div className="form-group row text-xs-center">
                        ...
                        <div className="col-xs-4 text-xs-left">
                            <input className={ "form-control" + ( errors.from ? ' alert-danger' : '' ) } defaultValue={todayPlusOne} type="date" id="from" placeholder="YYYY-MM-DD"/>
                        ...
                        <div className="col-xs-4 text-xs-left">
                            <input className={ "form-control" + ( errors.to ? ' alert-danger' : '' ) } defaultValue={todayPlusFive} type="date" id="to" placeholder="YYYY-MM-DD"/>
                    ...
                    <div className="form-group row text-xs-center">
                        ...
                        <div className="col-xs-9 col-sm-10 text-xs-left">
                            <textarea className={ "form-control" + ( errors.text ? ' alert-danger' : '' ) } type="text" id="text" rows="3"
